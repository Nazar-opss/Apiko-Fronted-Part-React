            ...
            <div className={styles.filter_container}>
                <div className={styles.filter_search}>
                    ...
                    <input
                        ...
                        className="block w-full rounded-md border-0 py-1.5 pl-9 pr-22 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                    ...
                    <div className="relative">
                        ...
                        {optionsCategory.map((option) => (
                            <ListboxOption
                                ...
                                className="group relative cursor-default select-none py-1 pl-1 pr-3 text-gray-900 data-[focus]:bg-select-hover data-[focus]:text-white"
                            >
