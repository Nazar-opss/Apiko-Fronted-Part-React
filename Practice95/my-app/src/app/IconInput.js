...
function IconInput({type, name, errors, isVisible, handleIcon, placeholder, fieldRef, hasError}) {
  return (
    ...
    <div className="relative mt-5">
      ...
      <label
        for={name}
        className="absolute text-base leading-[19px] select-none text-dark_2 tracking-[0.25px] duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-whit px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-2"
      >
        {placeholder}
      </label>
    </div>
