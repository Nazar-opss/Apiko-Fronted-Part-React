...
const Item = (props) => { 
    return(
        <div class="w-full max-w-[209px] max-h-[212px] mb-2.5 flex flex-col justify-between bg-white border border-dark_3 rounded-sm shadow item-shadow dark:bg-gray-800 dark:border-gray-700" >
            <a href="#" className='flex justify-center'>
                <Image
                    className='max-w-[201px] max-h-[147px] mt-1 rounded-[3px] mb-[6px]'
                    src={props.picture}
                    alt={props.title}
                    width={201}
                    height={147}
...
// глянути відоси по нексту, вивід в консоль фікс
